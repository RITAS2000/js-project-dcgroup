import{S as v,A as h,a as w,N as b,K as g,b as L}from"./assets/vendor-Bn2HYO1D.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function o(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(s){if(s.ep)return;s.ep=!0;const n=o(s);fetch(s.href,n)}})();document.addEventListener("DOMContentLoaded",()=>{const e=document.getElementById("menu-btn"),t=document.getElementById("dropdown-menu"),o=document.getElementById("burger"),r=document.getElementById("mobile-menu"),s=document.getElementById("close-btn"),n=document.querySelectorAll(".mobile-link");e.addEventListener("click",()=>{t.classList.toggle("show")}),o.addEventListener("click",()=>{r.classList.add("active"),document.body.style.overflow="hidden"}),s.addEventListener("click",()=>{r.classList.remove("active"),document.body.style.overflow="auto"}),n.forEach(i=>{i.addEventListener("click",()=>{r.classList.remove("active"),document.body.style.overflow="auto"})}),document.addEventListener("click",i=>{!e.contains(i.target)&&!t.contains(i.target)&&t.classList.remove("show")})});const m=document.querySelectorAll(".accordion-item"),k=document.querySelectorAll(".accordion-content");m.forEach(e=>e.addEventListener("click",()=>{const t=document.querySelector("#"+e.dataset.tab);t.classList.contains("active")?t.classList.remove("active"):(k.forEach(o=>{o.classList.remove("active"),o.style.maxHeight="0"}),m.forEach(o=>o.classList.remove("active")),e.classList.add("active"),t.classList.add("active"),t.style.maxHeight=t.scrollHeight+"px")}));const a=new v(".projects-swiper",{slidesPerView:1,spaceBetween:20,keyboard:{enabled:!0,onlyInViewport:!0},a11y:!0}),u=document.querySelector(".icon-wrapper.left"),y=document.querySelector(".icon-wrapper.right");u.addEventListener("click",()=>a.slidePrev());y.addEventListener("click",()=>a.slideNext());a.on("slideChange",()=>{u.classList.toggle("disabled",a.isBeginning),y.classList.toggle("disabled",a.isEnd)});a.on("init",()=>{u.classList.add("disabled")});new h(".accordion-container");const E="https://portfolio-js.b.goit.study/api/reviews";async function x(){try{return(await w.get(E)).data}catch(e){throw console.error("Error fetching reviews:",e),new Error("Failed to fetch reviews")}}async function B(){const e=document.getElementById("reviews-list");if(e)try{const t=await x();e.innerHTML=t.map(o=>`<li class="reviews-swiper-slide swiper-slide">
        ...
        </li>`).join(""),S()}catch{e.innerHTML='<p class="error-message">Not found</p>'}}B();function S(){new v(".reviews-swiper",{modules:[b,g],slidesPerView:"auto",navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},keyboard:{enabled:!0,onlyInViewport:!0},breakpoints:{320:{slidesPerView:1},768:{slidesPerView:2,grabCursor:!0,spaceBetween:16},1440:{slidesPerView:4,grabCursor:!0,spaceBetween:16}},on:{slideChange:function(){const e=document.querySelector(".swiper-button-prev"),t=document.querySelector(".swiper-button-next");e.disabled=this.isBeginning,t.disabled=this.isEnd,this.isBeginning?e.classList.add("disabled"):e.classList.remove("disabled"),this.isEnd?t.classList.add("disabled"):t.classList.remove("disabled")}}})}let d=!1;const f=document.querySelector(".work-form"),l=document.querySelector(".work-input"),c=document.querySelector(".js-input-message");l.addEventListener("input",A);function A(){l.value.trim()?l.checkValidity()?(c.textContent="Succes!",c.classList.remove("error"),c.classList.add("success"),c.style.visibility="visible",l.style.borderBottom="1px solid #3cbc81"):(c.textContent="Invalid email, try again",c.classList.remove("success"),c.classList.add("error"),c.style.visibility="visible",l.style.borderBottom="1px solid #e74a3b"):(c.style.visibility="hidden",l.style.borderBottom="1px solid rgba(250, 250, 250, 0.2)")}f.addEventListener("submit",q);function q(e){if(e.preventDefault(),d)return;const t=document.querySelector('input[type="email"]').value.trim(),o=document.querySelector('input[type="text"]').value.trim(),r={email:t,comment:o},s="https://portfolio-js.b.goit.study/api-docs/reqests";d=!0,w.post(s,r,{headers:{"Content-Type":"application/json"}}).then(n=>{f.reset(),c.style.visibility="hidden",l.style.borderBottom="1px solid rgba(250, 250, 250, 0.2)",p("success")}).catch(n=>{p("error")}).finally(()=>{d=!1})}function p(e){const t=F(e),o=L.create(t);o.show(),document.body.style.overflow="hidden";const r=o.element().querySelector(".work-close-btn");r.addEventListener("click",s);function s(){o.close(),document.body.style.overflow="",r.removeEventListener("click",s),document.removeEventListener("keydown",n)}document.addEventListener("keydown",n);function n(i){i.key==="Escape"&&(document.activeElement.blur(),o.close(),document.body.style.overflow="",r.removeEventListener("click",s),document.removeEventListener("keydown",n))}}function F(e){if(e==="success")return`
