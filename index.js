import{S as w,a as y,N as f,K as b,b as h}from"./assets/vendor-CSo1eIpR.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))l(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&l(a)}).observe(document,{childList:!0,subtree:!0});function r(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function l(e){if(e.ep)return;e.ep=!0;const s=r(e);fetch(e.href,s)}})();const c=new w(".swiper",{slidesPerView:1,spaceBetween:20,keyboard:{enabled:!0,onlyInViewport:!0},a11y:!0}),d=document.querySelector(".icon-wrapper.left"),v=document.querySelector(".icon-wrapper.right");d.addEventListener("click",()=>c.slidePrev());v.addEventListener("click",()=>c.slideNext());c.on("slideChange",()=>{d.classList.toggle("disabled",c.isBeginning),v.classList.toggle("disabled",c.isEnd)});c.on("init",()=>{d.classList.add("disabled")});c.init();const g="https://portfolio-js.b.goit.study/api/reviews";async function k(){try{return(await y.get(g)).data}catch(t){throw console.error("Error fetching reviews:",t),new Error("Failed to fetch reviews")}}async function L(){const t=document.getElementById("reviews-list");if(t)try{const o=await k();t.innerHTML=o.map(r=>`<li class="swiper-slide">
